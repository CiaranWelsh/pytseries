...
from timeseries.core import TimeSeriesGroup
...
class _BaseClust(object):
    """
    Clustering methods in `timeseries.clust` inherit from tslearn
    classes. This class provides additional methods for interacting with the
    timeseries classes and plotting
    """
...
class TimeSeriesKMeans(_BaseClust, clustering.TimeSeriesKMeans):
    ...
    have added the tsg parameter which is a `timeseries.TimeSeriesGroup` object

    Parameters
    ----------
    tsg: A `timeseries.TimeSeriesGroup` object
